...
@section('content-header')
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="{{ route('articles.create') }}">Add Article</a></li>
    </ol>
@endsection
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <form action="https://cwc-training-blog-app.local.host/articles" method="POST" enctype="multipart/form-data">
                    @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="article_category_id" id="article_category_id" class="form-control select2" style="width: 100%;">
                                        ...
                                        @foreach($articleCategories as $articleCategory)
                                            @if($articleCategory->id == old('article_category_id'))
